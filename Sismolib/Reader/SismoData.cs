...
namespace Sismolib
{
    ...
    public class SismoData : EventArgs
    {
        ...
        public void ExtractValue(NationalInstruments.AnalogWaveformSample<double> analoginput, SismoAxis ax)
        {
        ...
        //get del valore acquisito
        public Sismolib.SismoAxis axis
        {
            get
            {
                return _axis;
