...
namespace Sismolib
{
    ...
    public partial class Config : Form
    {
        ...
        private void SaveDefaultGeneralSettigs()
        {
            Properties.Settings.Default.NotificationIcon = ckbNotifyIcon.Checked;
        }
        ...
        {
            if (ckbNotifyIcon.Checked)
            {
                SismoNotifyIcon.Show();
            }
            else
            {
                SismoNotifyIcon.Hide();
            }
        }
